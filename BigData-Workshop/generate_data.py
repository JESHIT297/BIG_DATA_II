...
products = [
    "Televisor", "Celular", "Laptop", "Camisa", "Panralon", "Zapatos", "Sofa", "Mesa", "Silla"
]
...
with open("BigData-Workshop/sales.csv", "w", newline="", encoding="utf-8") as file:
    ...
    for i in range(1, 100001):
        ...
        catgory = "Electronica" if product in ["Televisor", "Celular", "Laptop"] else "Ropa" if product in ["Camisa", "Panralon", "Zapatos"] else "Hogar"
